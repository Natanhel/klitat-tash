  ...
  methods: {
    ...
    uploadFile() {
      ...
      var config = {
        ...
        headers: { 
          'Authorization': 'Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJfaWQiOiI1ZjNkM2M0Zjk5Y2MxMjAwMTczNjY3NDIiLCJpYXQiOjE1OTg2ODgyMTl9.drtlyHUgHeodNRl98MxxDEJMbywure77W5BerkkoBFY', 
          ...data.getHeaders()
        },
        data : data
      }
